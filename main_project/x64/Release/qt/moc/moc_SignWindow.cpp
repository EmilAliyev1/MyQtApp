...
struct qt_meta_stringdata_CLASSSignWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSignWindowENDCLASS = QtMocHelpers::stringData(
    "SignWindow",
    "onLoginClicked",
    "",
    "onSignupClicked",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSignWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SignWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSignWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSignWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSignWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void SignWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->setLoginForm(); break;
        case 5: _t->setSignupForm(); break;
        case 6: _t->allDoneClose(); break;
        default: ;
        }
    }
    (void)_a;
...
void *SignWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSignWindowENDCLASS.stringdata0))
